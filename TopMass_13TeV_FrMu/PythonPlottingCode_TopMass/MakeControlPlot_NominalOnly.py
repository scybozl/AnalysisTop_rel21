...
def GetAllHistograms(FolderName, SystFlag, HistoName, ExtraFlag, DataPeriod, RelFlag):
    ...
    TTbar     = ReturnHistogram(FolderName+"/Merge_ttbar_PP8"+Flag+".root",        HistoName)
    SingleTop = ReturnHistogram(FolderName+"/Merge_ST_PP8"+Flag+".root",    HistoName)
    Wjets     = ReturnHistogram(FolderName+"/Merge_Wjets_Sherpa"+Flag+".root",        HistoName)
    Zjets     = ReturnHistogram(FolderName+"/Merge_Zjets_Sherpa"+Flag+".root",        HistoName)
    Diboson   = ReturnHistogram(FolderName+"/Merge_Dibos_Sherpa"+Flag+".root",      HistoName)
    TTV       = ReturnHistogram(FolderName+"/Merge_TTV_Madgraph"+Flag+".root",          HistoName)
