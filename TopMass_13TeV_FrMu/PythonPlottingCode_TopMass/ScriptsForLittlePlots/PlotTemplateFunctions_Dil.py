...
def ratioplot(histVec, nameVec, outputFile, Var, ic, Dependence):
    ...
    if "mlb" in outputFile:
         histVec[0].GetYaxis().SetTitle("Normalised events / 2 GeV")
...
if __name__ == "__main__":
    ...
    if "mlb" in HistoName:
         Var = "m_{lb}^{reco} [GeV]"
         outputFile = outputFile+"mlb"

    if Dependence == "mtop":
         func_mtop_mtop1 = TF1()
         func_mtop_mtop1 = EvalFitFunction_Dil.EvalFitFunction_mlb(171.0, BinWidth, InputFolder)
         func_mtop_mtop2 = TF1()
         func_mtop_mtop2 = EvalFitFunction_Dil.EvalFitFunction_mlb(172.5, BinWidth, InputFolder)
         func_mtop_mtop3 = TF1()
         func_mtop_mtop3 = EvalFitFunction_Dil.EvalFitFunction_mlb(174.0, BinWidth, InputFolder)
         
         Vec1 = [fH1, fH2, fH3, func_mtop_mtop1, func_mtop_mtop2, func_mtop_mtop3]
         Vec2 = ["171.0", "172.5", "174.0"]
         ratioplot(Vec1, Vec2, outputFile+"_mtop_Dil.pdf", Var, 0, "mlb")
