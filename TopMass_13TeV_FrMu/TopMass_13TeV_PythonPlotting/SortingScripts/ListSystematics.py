...
# only b-tagging SF
def ReturnBtagSFList(WP):
    List = []
    List.append(["bTagSF_"+WP+"_B_0", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_up_0", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_down_0", "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_B_1", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_up_1", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_down_1", "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_B_2", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_up_2", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_down_2", "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_B_3", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_up_3", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_down_3", "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_B_4", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_up_4", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_down_4", "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_B_5", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_up_5", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_down_5", "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_B_6", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_up_6", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_down_6", "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_B_7", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_up_7", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_down_7", "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_B_8", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_up_8", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_B_down_8", "weight_bTagSF_MV2c10_"+WP+""])

    return List

# only c-tagging SF
def ReturnCtagSFList(WP):
    List = []
    List.append(["bTagSF_"+WP+"_C_0", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_C_up_0", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_C_down_0", "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_C_1", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_C_up_1", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_C_down_1", "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_C_2", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_C_up_2", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_C_down_2", "weight_bTagSF_MV2c10_"+WP+""])
    return List

# only mistagging SF
def ReturnMistagSFList(WP):
    List = []
    List.append(["bTagSF_"+WP+"_Light_0",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_0",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_0",  "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_Light_1",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_1",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_1",  "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_Light_2",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_2",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_2",  "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_Light_3",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_3",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_3",  "weight_bTagSF_MV2c10_"+WP+""])
    #List.append(["bTagSF_"+WP+"_Light_4",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_4",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_4",  "weight_bTagSF_MV2c10_"+WP+""])
    #List.append(["bTagSF_"+WP+"_Light_5",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_5",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_5",  "weight_bTagSF_MV2c10_"+WP+""])
    #List.append(["bTagSF_"+WP+"_Light_6",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_6",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_6",  "weight_bTagSF_MV2c10_"+WP+""])
    #List.append(["bTagSF_"+WP+"_Light_7",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_7",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_7",  "weight_bTagSF_MV2c10_"+WP+""])
    #List.append(["bTagSF_"+WP+"_Light_8",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_8",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_8",  "weight_bTagSF_MV2c10_"+WP+""])
    #List.append(["bTagSF_"+WP+"_Light_9",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_9",  "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_9",  "weight_bTagSF_MV2c10_"+WP+""])
    #List.append(["bTagSF_"+WP+"_Light_10", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_10", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_10", "weight_bTagSF_MV2c10_"+WP+""])
    #List.append(["bTagSF_"+WP+"_Light_11", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_11", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_11", "weight_bTagSF_MV2c10_"+WP+""])
    #List.append(["bTagSF_"+WP+"_Light_12", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_12", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_12", "weight_bTagSF_MV2c10_"+WP+""])
    #List.append(["bTagSF_"+WP+"_Light_13", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_13", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_13", "weight_bTagSF_MV2c10_"+WP+""])
    #List.append(["bTagSF_"+WP+"_Light_14", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_14", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_14", "weight_bTagSF_MV2c10_"+WP+""])
    #List.append(["bTagSF_"+WP+"_Light_15", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_up_15", "weight_bTagSF_MV2c10_"+WP+"_eigenvars_Light_down_15", "weight_bTagSF_MV2c10_"+WP+""])
    return List

def ReturnTagExtrapolationList(WP):
    List = []
    List.append(["bTagSF_"+WP+"_Extrap",       "weight_bTagSF_MV2c10_"+WP+"_extrapolation_up",            "weight_bTagSF_MV2c10_"+WP+"_extrapolation_down",            "weight_bTagSF_MV2c10_"+WP+""])
    List.append(["bTagSF_"+WP+"_Extrap_charm", "weight_bTagSF_MV2c10_"+WP+"_extrapolation_from_charm_up", "weight_bTagSF_MV2c10_"+WP+"_extrapolation_from_charm_down", "weight_bTagSF_MV2c10_"+WP+""])
    return List
...
def ReturnJERList():
    ...
    List.append(["JER_EffectiveNP_1", "JET_CategoryReduction_JET_JER_EffectiveNP_1__1up", "JET_CategoryReduction_JET_JER_EffectiveNP_1__1down"])
    List.append(["JER_EffectiveNP_2", "JET_CategoryReduction_JET_JER_EffectiveNP_2__1up", "JET_CategoryReduction_JET_JER_EffectiveNP_2__1down"])
    List.append(["JER_EffectiveNP_3", "JET_CategoryReduction_JET_JER_EffectiveNP_3__1up", "JET_CategoryReduction_JET_JER_EffectiveNP_3__1down"])
    List.append(["JER_EffectiveNP_4", "JET_CategoryReduction_JET_JER_EffectiveNP_4__1up", "JET_CategoryReduction_JET_JER_EffectiveNP_4__1down"])
    List.append(["JER_EffectiveNP_5", "JET_CategoryReduction_JET_JER_EffectiveNP_5__1up", "JET_CategoryReduction_JET_JER_EffectiveNP_5__1down"])
    List.append(["JER_EffectiveNP_6", "JET_CategoryReduction_JET_JER_EffectiveNP_6__1up", "JET_CategoryReduction_JET_JER_EffectiveNP_6__1down"])
    List.append(["JER_EffectiveNP_7restTerm", "JET_CategoryReduction_JET_JER_EffectiveNP_7restTerm__1up", "JET_CategoryReduction_JET_JER_EffectiveNP_7restTerm__1down"])
    List.append(["JER_DataVsMC", "JET_CategoryReduction_JET_JER_DataVsMC__1up", "JET_CategoryReduction_JET_JER_DataVsMC__1down"])
    return List
