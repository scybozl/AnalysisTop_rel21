...
PlotFolder    = sys.argv[4] #"CP_"+DataPeriod+"_Absolute/"
...
MainFolder    = NomFolder.replace("Out_NOM_FS/Merged_nominal/", "")
...
def main():
    ...
    FileNameHTML = PlotFolder+"/CP.html"
    
    out_html = open(FileNameHTML, "w")
    
    out_html.write("<html><head><title> Control plots for top mass template analysis </title></head> \n")
    out_html.write("<body> \n")
    out_html.write("<h1> Control plots for top mass template analysis, "+Channel+" "+CampaignFlag+" </h1> \n")
#    out_html.write("<a href=" << fHTMLLabel.c_str() << "> >=4 jets </a> \n")
     
    out_html.write("<br> <br>\n")

    out_html.write("<table border = 1> <tr> <th> name </th> <th> variable </th></tr> \n")
    ...
    for Var in VariableList:
        ...
        outputFile = histName.replace("h_", "")+".png"

        # <tr><td>nEvents</td><td><p><a href="nEvents_emujets_2016.png"><img src="nEvents_emujets_2016.png" width="70%"/><
        out_html.write("<tr><td>"+xTitle+"</td><td><p><a href=\""+outputFile+"\"><img src=\""+outputFile+"\" width=\"80%\"/></td> \n")
...
def ratioplot(h1, h2, HistVec, Name1, Name2, histName, xTitle, Channel):
    ...
    outputFile     = PlotFolder+"/"+histName.replace("h_", "")+".pdf"
    outputFileRoot = PlotFolder+"/"+histName.replace("h_", "")+".root"
